...
TUNING["underworld_hana.equip_slot"] = TUNING["underworld_hana.equip_slot"] or {}

-------------------------------------------------------------------------------------------------------------------
---- 背包
    TUNING["underworld_hana.equip_slot"].GetBackpackType = function(self)
...
-------------------------------------------------------------------------------------------------------------------
---- 项链
    TUNING["underworld_hana.equip_slot"].GetAmuletType = function(self)
...
-------------------------------------------------------------------------------------------------------------------
---- armor 盔甲
    TUNING["underworld_hana.equip_slot"].GetArmorType = function(self)
